      ...
      >
        <div class="flex gap-2 sm:gap-3 md:gap-4 items-start">
          ...
          <div class="flex-1 pt-0.5 sm:pt-1">
            <p class="text-gray-800 leading-relaxed text-base sm:text-lg verse-text" data-verse-pk="${verse.pk}" style="line-height: 1.7;">
            ...
            <!-- Comment -->
            ${verse.comment ? `
              <div class="mt-3 sm:mt-3 pl-3 sm:pl-4 border-l-2 border-amber-300 bg-amber-50/50 rounded-r-lg p-3 sm:p-3">
